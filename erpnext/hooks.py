...
doc_events = {
	...
	# "Purchase Order": {
	# 	"on_submit": "frappe.utils.print_format.download_pdf"
	# }
	# "Purchase Order": {
	# 	# "autoname": 'buying.autoname',
	# 	# "before_save":'erpnext.buying.doctype.purchase_order.purchase_order.PurchaseOrder.before_save'
	# 	"before_save":'erpnext.buying.doctype.purchase_order.purchase_order.PurchaseOrder.before_save'
	# }
}
