...
//                 frappe.call({
//                     method: 'erpnext.buying.doctype.purchase_order.purchase_order.send_purchase_order_to_docusign',
//                     args: {
//                         purchase_order_id: frm.doc.name,
//                         vendor_name: frm.doc.supplier_name,  // Replace with the correct field name
//                         vendor_email: 'vigneshwebdevelopr@gmail.com',  // Replace with the correct field name
//                         // attachment: frm.doc.attachment,  // Replace with the correct field name
//                     },
//                     callback: function(r) {
//                         if (!r.exc) {
