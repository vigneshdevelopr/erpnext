...
//         frm.add_custom_button('Convert to Fixed Asset', function() {
//             // Prompt the user to confirm the conversion
//             frappe.confirm('Are you sure you want to convert this item to a Fixed Asset?', function() {
//                 if (frm.doc.is_stock_item) {
...
//                     frappe.call({
//                         method: 'erpnext.stock.doctype.item.item.convert_to_fixed_asset',
//                         args: {
//                             item_name: frm.doc.name
//                         },
//                         callback: function(r) {
//                             if (r.message) {
//                                 frappe.msgprint('Item converted to Fixed Asset successfully.');
//                             } else {
//                                 frappe.msgprint('Failed to convert the item.');
//                             }
//                         }
//                     });
//                 } else {
//                     frappe.msgprint('Item is already set as a Fixed Asset.');
//                 }
//             });
//         });
//     }
...
//         // Create a custom button
//         frm.add_custom_button('Convert to Fixed Asset', function() {
//             if (!frm.doc.is_fixed_asset) { // Check if not already converted
//                 frappe.confirm('Are you sure you want to convert this item to a Fixed Asset?', function() {
//                     frappe.call({
//                         method: 'erpnext.stock.doctype.item.item.convert_to_fixed_asset',
//                         args: {
...
//                         callback: function(r) {
//                             if (r.message) {
//                                 frm.set_value('is_fixed_asset', 1); // Mark as converted
//                                 frappe.msgprint('Item converted to Fixed Asset successfully.');
//                             } else {
//                                 frappe.msgprint('Failed to convert the item.');
//                             }
