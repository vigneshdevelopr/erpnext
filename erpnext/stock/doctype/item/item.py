...
# @frappe.whitelist()
# def convert_to_fixed_asset(item_name):
#     item = frappe.get_doc('Item', item_name)
#     item.maintain_stock = 0
#     item.save()

#     fixed_asset = frappe.new_doc('Fixed Asset')
#     fixed_asset.asset_name = item.item_name
#     fixed_asset.asset_category = 'Stationary'
#     fixed_asset.purchase_date = frappe.utils.nowdate()
#     fixed_asset.gross_purchase_amount = item.valuation_rate
#     fixed_asset.insert()
#     return True
